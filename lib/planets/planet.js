...
Planet = (function() {
  ...
  function Planet(pjs, x, y, size, turnSpeed, name, gameinfo) {
    this.pjs = pjs;
    this.x = x;
    this.y = y;
    this.size = size;
  ...
  Planet.prototype.draw = function() {
    ...
    this.pjs.fill(0);
    if (this.clicked) {
      this.pjs.fill(0, 30, 200, 20);
      this.pjs.ellipse(0, 0, 100 + this.size * 1.2, 100 + this.size * 1.2);
      this.pjs.fill(0, 40, 0);
    }
